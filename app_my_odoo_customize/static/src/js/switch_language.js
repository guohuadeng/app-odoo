odoo.define('app_my_odoo_customize.switch_language', function (require) {
    "use strict";
                ...
                if (show.length >= 1 && (show[0]['value'] == "False"))
                    ...
                    new Model('res.lang').call('search_read', [[], ['name', 'code']]).then(function (res) {
                        _.each(res, function (lang) {
                            ...
                            lang_list += '<li><a href="#" data-menu="lang" data-lang-id="' + lang['code'] + '"><img class="flag" src="app_my_odoo_customize/static/src/img/flags/' + lang['code'] + '.png"/>' + lang['name'] + a + '</a></li>';
                        });
