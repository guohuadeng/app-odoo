...
35. Odoo 14+ compatibility and enhancement
...
21. 清除并重置会计科目表
22. 全新升级将用户及开发手册导航至国内网站，或者自己定义的网站
23. 增加清除网站数据功能
...
43. 可设置只允许管理员进入开发者模式，不可在url中直接debug=1来调试
...
49. 增加 SaaS 客户端开关，可让用户安装在线翻译同步模块及在线更新(仅odoo18)
50. 快速菜单管理，快速禁用/启用菜单
